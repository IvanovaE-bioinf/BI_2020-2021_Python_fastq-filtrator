import unittest
import os.path
from filtrator import genere_output_names, genere_files, line_reader, four_lines_read, filter_, count_gc, write_file, \
    filter_gc_content
...
class TestFiltration(unittest.TestCase):
    def setUp(self):
        ...
        self.four_lines_4 = ['@5\n',
                             'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG\n', \
                             '+\n',
