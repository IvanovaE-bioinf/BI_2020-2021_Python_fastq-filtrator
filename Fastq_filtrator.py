...
# it is a block with default constants and flags
min_length = 0
keep_filtered = 0
gc_bounds_low = None
gc_bounds_high = 101
...
Standard call for the tool looks like this:\n\
python Fastq_filtrator.py --some_argument some_values my_reads.fastq \n\n\
Optional arguments:\n\
    --min_length - minimal length of reads, which will pass the filtration\n\
    --gc_bounds - range of necessary percent of GC content.\n\
        If 1 value is specified, this is the lower threshold, if 2 are specified - \n\
        those are the lower and the upper thresholds, respectively.\n\
...
# This part filters the file according user's settings
